      ...
      <table id="listeSalle">
        ...
        <tbody>
          <tr v-for="salle in salles" :key="salle.id">
            ...
            <td><img :src="salle.photoSalle" alt="Photo" width="50" v-if="salle.photoSalle"></td>
            <td>{{ salle.tailleLongSalle }} m</td>
            <td>{{ salle.tailleLargSalle }} m</td>
            <td>{{ salle.prixSalleJournee }} €</td>
